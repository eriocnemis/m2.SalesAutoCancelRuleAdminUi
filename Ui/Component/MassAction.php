...
namespace Eriocnemis\SalesAutoCancelRuleAdminUi\Ui\Component;
...
class MassAction extends AbstractComponent
{
    ...
    public function isAllowed($actionType): bool
    {
        ...
        switch ($actionType) {
            case 'delete':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_AutoCancel::rule_delete');
                break;
            case 'status':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_AutoCancel::rule_edit');
                break;
        }
        return $isAllowed;
    }
